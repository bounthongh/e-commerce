        ...
        this.props.form.validateFieldsAndScroll((err, values) => {
            if (!err) {
                request.post('/users', {
                  ...
                  //  "VDR_NAME": values.USR_LOGIN,
                    "MARKET_IDS": [
                        values.MKT_ID
                    ]
                }, () => {
                    this.props.history.push('/login');
                    message.success('Le Compte à été créé avec succès');
                }, () => {
...
const FormRegisterCustomer = Form.create({name: 'register'})(RegistrationForm);

export default withRouter(FormRegisterCustomer);
